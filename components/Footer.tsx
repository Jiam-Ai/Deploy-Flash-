...
const Footer = () => {
    ...
    return (
        <footer className="fixed bottom-0 left-0 right-0 bg-black/60 backdrop-blur-xl p-3 z-50 text-neutral-300 text-xs sm:text-sm border-t border-white/5 shadow-[0_-5px_30px_rgba(0,0,0,0.3)]">
            <div className="max-w-screen-xl mx-auto flex flex-wrap justify-center items-center gap-x-6 gap-y-2 px-4">
                ...
                <div className="hidden md:flex items-center gap-4 text-neutral-400 whitespace-nowrap">
                    <p className="tracking-wide">Powered by jiam.ai</p>
                    ...
                    <p>
                        ...
                        <a
                            ...
                            className="text-neutral-300 hover:text-cyan-400 transition-colors duration-200 font-medium"
                        >
                            @Project Kidd
                        </a>
                    </p>
                ...
                <div className="hidden lg:flex items-center gap-2 text-neutral-300 min-w-0">
                    <span className="flex-shrink-0 text-cyan-400/80 font-medium">Remix this app...</span>
                ...
                <div className="flex flex-row flex-wrap justify-center items-center gap-3 sm:gap-6">
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-permanent-marker text-sm text-cyan-300 hover:text-black bg-cyan-900/20 hover:bg-cyan-400 border border-cyan-400/30 hover:border-cyan-400 py-1.5 px-3.5 rounded-lg transition-all duration-300 whitespace-nowrap backdrop-blur-sm"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-permanent-marker text-sm text-neutral-400 hover:text-white bg-transparent hover:bg-white/10 border border-transparent hover:border-white/20 py-1.5 px-3.5 rounded-lg transition-all duration-300 whitespace-nowrap"
                    >
                        Contact Dev
                    </a>
                </div>
